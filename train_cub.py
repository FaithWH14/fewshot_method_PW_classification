...
datapath = '/mnt/c/Users/faithwh14/Desktop/PW1/PW_video/train_image'  #your own path
...
def train(model, criterion, optimizer, scheduler,num_epochs=50,CNloss=True):
    ...
    for epoch in range(num_epochs):
        ...
        if epoch_loss < best_loss:
            ...
            torch.save(model.state_dict(), "/mnt/c/Users/faithwh14/Desktop/PW1/models/temp_.pkl") #hard coded
            torch.save(model, "/mnt/c/Users/faith14/Desktop/PW1/models/")
